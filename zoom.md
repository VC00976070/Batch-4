...
| RAM | 4 GB | 16 GB |
| OS | Windows 10/11, | Latest OS version with updates |

## Install Zoom Desktop Client

1. Open your browser and go to [zoom.us/download](https://zoom.us/download).
1. Locate the Zoom Desktop Client section and click Download.
    > **Note:** This saves the installer file to your device.
1. Run the Installer:
    - **On Windows**: Double-click `ZoomInstaller.exe`.
    * **On macOS**: Double-click `Zoom.pkg`.
2. Follow the Setup Wizard.
3. Accept the license terms.
4. Choose your installation directory to add the program files.
5. Click **Install** and wait for setup to complete.
6. Click **Finish** or __Close__ once the installation is complete.
7. Open Zoom from your desktop or Applications folder.
...
> **Tip:** You can also sign in with Google, Facebook, or SSO.
